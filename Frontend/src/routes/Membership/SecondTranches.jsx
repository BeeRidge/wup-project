            ...
            <table className="w-full border-collapse border border-green-700">
                <thead>
                    <tr className="bg-green-700 text-white">
                        ...
                        <th className="px-4 py-2">Health Assessment No.</th>
                        <th className="px-4 py-2">Consultation No.</th>
                    ...
                    {membershipData.length > 0 ? (
                        membershipData.map((member, index) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-2">{member.ConNumber}</td>
                                ...
                                <td className="px-4 py-2">{formatDate(member.ConsultationDate)}</td>
                            </tr>
                        ))
                    ) : (
                        <tr>
